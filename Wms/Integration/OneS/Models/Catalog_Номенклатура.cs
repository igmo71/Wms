...
internal class Catalog_Номенклатура
{
    ...
    private static readonly string select = "Ref_Key,DeletionMark,Parent_Key,IsFolder,Code,Description,Артикул,ЕдиницаИзмерения_Key," +
        "ВесИспользовать,ВесЕдиницаИзмерения_Key,ВесЧислитель,ВесЗнаменатель," +
        "ОбъемИспользовать,ОбъемЕдиницаИзмерения_Key,ОбъемЧислитель,ОбъемЗнаменатель";
}
