...
{
    [Inject] private InventoryTurnoverService InventoryTurnoverService { get; set; } = null!;
        ...
        CancellationToken cancellationToken)
    {
        ...
        var result = await InventoryTurnoverService.ListAsync(new InventoryTurnoverListQuery
        {
            DateFrom = _dateFrom,
            DateTo = _dateTo,
